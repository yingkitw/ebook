...
- [x] **MCP parity: read/write/validate/info now supports epub, pdf, txt, mobi, fb2, azw, cbz where applicable**
- [x] **MCP integration tests (initialize, tools/list, tools/call for write/read/validate/info) (2 tests)**
...
- [x] All tests passing (Currently: 103 tests - 13 unit + 8 AZW + 5 CBZ metadata + 7 CLI optimize + 13 CLI + 11 conversion + 7 EPUB + 6 EPUB3 + 6 image optimization + 6 MOBI + 6 PDF + 8 streaming + 6 TXT + 4 trait streaming + 5 error hints + 2 MCP integration)
